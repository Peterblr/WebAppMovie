    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CollectionMoviesId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CollectionMovies", x => x.CollectionMoviesId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CollectionMoviesId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Movies", x => x.MovieId);
                    table.ForeignKey(
                        name: "FK_Movies_CollectionMovies_CollectionMoviesId",
                        column: x => x.CollectionMoviesId,
                        principalTable: "CollectionMovies",
                        principalColumn: "CollectionMoviesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movies_CollectionMoviesId",
                table: "Movies",
                column: "CollectionMoviesId");
